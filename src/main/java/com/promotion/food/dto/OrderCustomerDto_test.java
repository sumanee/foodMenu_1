...
@Getter
@NoArgsConstructor
public class OrderCustomerDto_test {
    ...
    public static class  TypeFood {
        private Integer numberTable;
        private List<OrderCustomerDto_test.TypeFoods> TypeFoodList;
    }
    ...
    public static class  TypeFoods {
        ...
        private List<OrderCustomerDto_test.IngredientDto> ingredientList;
    }
